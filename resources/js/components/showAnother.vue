      ...
      <div v-if="resume.experiences.length || experianceData.job_title">
        ...
        <div :key="experience.id" v-for="experience in resume.experiences">
          ...
          <p>
            ...
            {{ (experience.work_here && "present") || experience.end_at }}
          </p>
        ...
        <div>
          ...
          <p>
            {{ experianceData.start_at }} {{ experianceData.start_at }}
            {{
              (experianceData.work_here && "present") || experianceData.end_at
            }}
          </p>
...
<script>
export default {
  props: ["resume", "experiance", "education", "skill", "summary", "custom"],
  data() {
    return {
