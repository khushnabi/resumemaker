        ...
        <div>
          <div>
            ...
            <div class="display-flex">
              ...
              <div>
                <router-link :to="`/resumes/templates`"
                  ><button class="create-new">Create new</button></router-link
                >
              </div>
            </div>
                    ...
                    <div class="display-flex">
                        ...
                        <div :class="`${resume.templete} display-flex resumes`">
                          <div class="sideBar">
                            ...
                            <div v-if="resume.summaries.length">
                              <h3 class="uppercase text" style="color: #fff">
                                About me
                              </h3>
                              <div class="little-spacer"></div>
                              <div
                                :key="summary.id"
                                v-for="summary in resume.summaries"
                              >
                                <p
                                  class="summary-para para"
                                  style="
                          ...
                          <div class="article">
                            <div class="prifile-section">
                              <div class="head-section">
                                <h2
                                  :class="`big-heading`"
                                  v-if="resume.first_name || resume.last_name"
                                >
                              ...
                              <div>
                                <div v-if="resume.address" class="display-flex">
                                  ...
                                  <div class="text-section">
                                    <p :class="`para `" v-if="resume.address">
                                ...
                                <div v-if="resume.phone" class="display-flex">
                                  ...
                                  <div class="text-section">
                                    <p :class="`para `" v-if="resume.phone">
                                      {{ resume.phone }}
                                    </p>
                                  </div>
                                </div>
                                <div v-if="resume.email" class="display-flex">
                                  ...
                                  <div class="text-section">
                                    <p :class="`para `" v-if="resume.email">
                                      {{ resume.email }}
                                    </p>
                                  </div>
                                </div>
                            ...
                            <div class="skill" v-if="resume.skills.length">
                              ...
                              <div class="progress-container">
                                ...
                                >
                                  <p class="para uppercase">
                                    {{ skill.skill }}
                                  </p>
                                  <div v-if="skill.level" class="progress-bar">
                                    <div
                                      :class="`progress ${skill.level}`"
                                    ></div>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div>
                        <div class="edit-section">
                          ...
                          <p class="created">
                            <span v-if="resume.created_at"
                              >created
                              {{ timeFormate(resume.created_at) }}</span
                            >
                            <span v-else-if="resume.updated_at"
                              >updated
                              {{ timeFormate(resume.updated_at) }}</span
                            >
                          </p>
                          <div class="edit">
                            <router-link :to="`/resumes/${resume.id}/edit`"
                          ...
                          <div class="download">
                            <router-link
                              :to="`/resumes/${resume.id}/${resume.templete}/download`"
                            >
                              <Icon
                                size="18"
                                color="rgb(40, 43, 50)"
                          ...
                          <div class="delete">
                            <div type="error" @click="isDeleted(resume, i)">
                              <Icon
                                size="18"
                                color="rgb(40, 43, 50)"
                                type="ios-trash"
                        ...
                        <Modal v-model="isDeletedModel" width="360">
                          ...
                          <div slot="footer">
                            <Button
                              ...
                              long
                              @click="
                                onDelete(delete_data, delete_data.id, index)
                              "
                              :loading="resume.isDeleting"
      ...
      try {
        ...
        resume.experiences.forEach(async (exp) => {
          const { ex } = await Axios.post(
            `/api/resumes/${data.id}/experiences`,
            exp
          );
        });
        ...
        resume.educations.forEach(async (edu) => {
          const res = await Axios.post(
            `/api/resumes/${data.id}/educations`,
            edu
          );
        });
        ...
        resume.summaries.forEach(async (summary) => {
          const res = await Axios.post(
            `/api/resumes/${this.resumeId}/summaries`,
            summary
          );
        });
        ...
        resume.customs.forEach(async (custom) => {
          const res = await Axios.post(
            `/api/resumes/${this.resumeId}/customs`,
            custom
          );
        });
