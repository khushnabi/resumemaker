  ...
  <div>
    ...
    <div>
      ...
      <Experiance
        ...
        :resumeId="resumeId"
        v-on:expData="experianceData($event)"
      ></Experiance>
    </div>
    ...
    <div>
      ...
      <Education
        :education="education"
        :resumeId="resumeId"
        v-on:eduData="geteducationData($event)"
      ></Education>
    </div>
    ...
    <div>
      ...
      <Skill
        :skill="skill"
        :resumeId="resumeId"
        v-on:skillData="skillData($event)"
      ></Skill>
    </div>
    <div>
      <div>
      ...
      <Summary
        :summary="summary"
        :resumeId="resumeId"
        v-on:summaryData="getSummary($event)"
      ></Summary>
    </div>
    <div>
      <div>
      ...
      <Custom
        :custom="custom"
        :resumeId="resumeId"
        v-on:customData="getCustomData($event)"
      ></Custom>
    </div>
    ...
    <div class="button-wrap">
      <router-link :to="`/resumes/${resumeId}/${templete}/download`"
        ><Button type="primary"
          >next to download <Icon type="md-arrow-round-forward" /></Button
      ></router-link>
    </div>
  </div>
</template>
