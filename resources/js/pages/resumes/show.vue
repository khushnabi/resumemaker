      ...
      <Layout>
        ...
        >
          <div class="resume-container">
            <div
              class="template1 display-flex show resumes"
              @click="selectTemplete('template1')"
            >
              <div class="sideBar">
                  ...
                  <div class="progress-container">
                    <div class="skillData">
                      ...
                      <div class="progress-bar">
                        <div :class="`progress skillfull`"></div>
                      </div>
                    </div>
                    <div class="skillData">
          ...
          <div class="resume-container">
            <div
              class="template2 show display-flex resumes"
              @click="selectTemplete('template2')"
            >
              <div class="sideBar">
                <div style="margin-bottom: 15px" class="text-center">
                  <img class="img" src="/uploads/1609947566.jpeg" />
            ...
            <div class="print-container display-flex">
              ...
              <div>
                <div class="print-hidden" v-if="isDownloaded">
                  <router-link
                    :to="`/resumes/${resume.templete}/${resume.id}/final`"
                    ><h1><Icon type="md-close" /></h1
                  ></router-link>
                </div>
...
export default {
  ...
  async mounted() {
    ...
    console.log(
      this.$route.path === `/resumes/${this.id}/${this.templete}/download`
    );
