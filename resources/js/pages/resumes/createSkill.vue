        ...
        <div class="overflow">
          ...
          <div class="formContainer">
            <h4 class="form-header">
              <div>
                <span class="primary-color">Tell us </span>about your Skills
              </div>
            </h4>
            <p class="form-para">
            ...
            <div class="buttons-container">
              <div>
                <router-link :to="`/resumes/${templete}/${id}/education`"
                  ><button class="back">
              ...
              <div>
                <router-link :to="`/resumes/${templete}/${id}/summary`"
                  ><Button type="primary" style="margin-left: 8px"
                    >next to Summary<Icon
                      type="md-arrow-round-forward" /></Button
                ></router-link>
              </div>
            </div>
          </div>
