        ...
        <Col class="form-baground" span="12">
          ...
          <div class="formContainer">
            <h4 class="form-header">
              <div>
                <span class="primary-color">Write down </span> your Professional
                summary
              </div>
            </h4>
            <p class="form-para">
              Include up to 3 sentences that describe your general experience
            </p>

            <CreateSummary
              :summary="summary"
              :resumeId="id"
              v-on:summaryData="summaryData($event)"
            />

            <div class="buttons-container">
              <div>
                <router-link :to="`/resumes/${templete}/${id}/skill`"
                  ><button class="back">
                    <Icon size="17" type="md-arrow-round-back" />{{ " " }}Back
                  </button></router-link
                >
              </div>
              <div>
                <router-link :to="`/resumes/${templete}/${id}/final`"
                  ><Button type="primary" style="margin-left: 8px"
                    >next to Final<Icon type="md-arrow-round-forward" /></Button
                ></router-link>
              </div>
            </div>
          </div>
